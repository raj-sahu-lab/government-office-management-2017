...
<form name="form1">
<br/>
<b>Krutidev-010 कृतिदेव</b> font text-box यहां पेस्ट करें<br/>

<textarea name="TextToConvert" id="legacy_text" cols="80" rows="8"></textarea> <br>

<div align="middle">
<input  type="button" name="converter" id="converter" value=" Convert to Unicode यूनिकोड >> " onClick="convert_to_unicode();" accesskey="c" title="शॉर्टकट यूनिकोड"> 
</div>  <br>

<b>Unicode यूनिकोड</b> text-box यहां पेस्ट करें<br/>
<textarea name="ConvertedText" id="unicode_text" cols="84" rows="11"></textarea>
<br />

<div align="middle">
<input  type="button" id="converter" name="converter" value=" Convert to Kritidev-010 कृतिदेव >> " onClick="Convert_to_Kritidev_010();" accesskey="c" 
</div>
